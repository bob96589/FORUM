...
public final class AuthenticationTokenDetails {
    ...
    private AuthenticationTokenDetails(String id, String username, Set<String> authorities, ZonedDateTime issuedDate, ZonedDateTime expirationDate, int refreshCount, int refreshLimit) {
        this.id = id;
