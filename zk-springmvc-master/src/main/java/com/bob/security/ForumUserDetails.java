...
public class ForumUserDetails implements UserDetails, CredentialsContainer {
    ...
    public boolean equals(Object rhs) {
        if (rhs instanceof ForumUserDetails) {
            return username.equals(((ForumUserDetails) rhs).username);
        }
        return false;
    }
